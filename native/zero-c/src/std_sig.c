...
const ZStdHelperInfo z_std_helpers[] = {
  ...
  {"std.collections.append", "usize", 3, {NULL}, {NULL}, "memory", "target-neutral", "writes non-overlapping caller storage; returns unchanged length on overflow or invalid length", true, Z_STD_HELPER_KIND_COLLECTIONS_APPEND},
  {"std.collections.contains", "Bool", 3, {NULL}, {NULL}, "memory", "target-neutral", "no allocation", true, Z_STD_HELPER_KIND_COLLECTIONS_LEN_VALUE},
  {"std.collections.count", "usize", 3, {NULL}, {NULL}, "memory", "target-neutral", "no allocation", true, Z_STD_HELPER_KIND_COLLECTIONS_LEN_VALUE},
  {"std.collections.moveToFront", "usize", 3, {NULL}, {NULL}, "memory", "target-neutral", "writes caller storage; returns unchanged length for invalid length or index", true, Z_STD_HELPER_KIND_COLLECTIONS_LEN_INDEX},
  {"std.collections.push", "usize", 3, {NULL}, {NULL}, "memory", "target-neutral", "writes caller storage; returns unchanged length on overflow", true, Z_STD_HELPER_KIND_COLLECTIONS_PUSH},
  {"std.collections.removeSwap", "usize", 3, {NULL}, {NULL}, "memory", "target-neutral", "writes caller storage; returns unchanged length for invalid length or index", true, Z_STD_HELPER_KIND_COLLECTIONS_LEN_INDEX},
  {"std.collections.view", "Span<T>", 2, {NULL}, {NULL}, "memory", "target-neutral", "borrows caller storage prefix", true, Z_STD_HELPER_KIND_COLLECTIONS_VIEW},
  ...
  {"std.search.indexOf", "usize", 2, {NULL}, {NULL}, "memory", "target-neutral", "no allocation; returns len when absent", true, Z_STD_HELPER_KIND_SEARCH_INDEX},
  {"std.search.lastIndexOf", "usize", 2, {NULL}, {NULL}, "memory", "target-neutral", "no allocation; returns len when absent", true, Z_STD_HELPER_KIND_SEARCH_INDEX},
  ...
  {"std.mem.copyItems", "usize", 2, {NULL}, {NULL}, "memory", "target-neutral", "writes caller buffer", true, Z_STD_HELPER_KIND_MEM_COPY_ITEMS},
  {"std.mem.fill", "usize", 2, {"MutSpan<u8>", "u8"}, {NULL}, "memory", "target-neutral", "writes caller buffer", true, Z_STD_HELPER_KIND_TABLE},
  {"std.mem.fillItems", "usize", 2, {NULL}, {NULL}, "memory", "target-neutral", "writes caller buffer", true, Z_STD_HELPER_KIND_MEM_FILL_ITEMS},
  ...
  {"std.mem.contains", "Bool", 2, {NULL}, {NULL}, "memory", "target-neutral", "no allocation", true, Z_STD_HELPER_KIND_MEM_CONTAINS},
  {"std.mem.isEmpty", "Bool", 1, {NULL}, {NULL}, "memory", "target-neutral", "no allocation", true, Z_STD_HELPER_KIND_MEM_IS_EMPTY},
  {"std.mem.prefix", "Span<T>", 2, {NULL, "usize"}, {NULL}, "memory", "target-neutral", "borrows input span", true, Z_STD_HELPER_KIND_MEM_SLICE},
  {"std.mem.dropPrefix", "Span<T>", 2, {NULL, "usize"}, {NULL}, "memory", "target-neutral", "borrows input span", true, Z_STD_HELPER_KIND_MEM_SLICE},
