...
assert.equal(repoGraphVerify.body.diagnostics[0].code, "GPH001");
...
assert.equal(repoGraphSyncNoDirection.body.diagnostics[0].code, "GPH002");
...
assert.equal(repoGraphSyncFromSource.body.diagnostics[0].code, "GPH001");
