...
const fileBudgets = {
  ...
  "native/zero-c/src/main.c": { maxLines: 13410, maxStrcmpCalls: 476 },
  ...
  "native/zero-c/src/program_graph_mir.c": { maxLines: 1265, maxStrcmpCalls: 3 },
  ...
  "native/zero-c/src/program_graph_semantics.c": { maxLines: 1240, maxStrcmpCalls: 1 },
...
function budgetViolations(files, allLargeFunctions, stdlib, backendFormats, programGraph) {
  ...
  if (!programGraph.repositoryGraphMirPrepTypedLowering ||
      !programGraph.repositoryGraphMirPrepNoAstFallback ||
